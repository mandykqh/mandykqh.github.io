const projects = [
    ...
    },
    {
        id: 'bitebalance',
        title: 'BiteBalance',
        overview: 'BiteBalance is a collaborative UI/UX design project undertaken by a team of five individuals, aimed at enhancing the meal planning experience through personalization. Our team meticulously followed each phase of the design process, iterating through Contextual Analysis, Data Analysis utilizing affinity diagramming techniques, crafting personas, developing scenarios and storyboards, prototyping, and conducting Usability Testing via heuristic evaluations.',
        role: 'Product Designer, Researcher \n• Involved in all phases of the design process',
        links: {

        },
        images: [
            'assets/img/BiteBalance/1.png',
            'assets/img/BiteBalance/2.png',
            'assets/img/BiteBalance/3.png',
            'assets/img/BiteBalance/4.png',
            'assets/img/BiteBalance/5.png',
            'assets/img/BiteBalance/6.png',
            'assets/img/BiteBalance/7.png',
            'assets/img/BiteBalance/8.png',
        ],
        date: 'Aug - Nov 2023',
        technologies: 'Figma, Balsamiq',
        buttons: {
...
function loadProject(projectId) {
    ...
    if (project) {
        ...
        prototypeContainer.classList.add(projectId);
        ...
        if (Object.keys(project.buttons).length > 0) {
            for (const buttonName in project.buttons) {
                if (project.buttons.hasOwnProperty(buttonName)) {
                    ...
                    button.onclick = function () { window.open(buttonUrl, '_blank'); };
